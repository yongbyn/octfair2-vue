<template>
  ...
  <template v-for="(item, key) in eduList?.payload" :key="key">
    <div class="edu_table">
      <div class="garo_wrapper_lr" style="grid-area: admDate">
        <label class="resume_label" class="garo_wrapper_lr_l">입학연도:</label>
        <textarea class="resume_textarea" class="garo_wrapper_lr_r" :value="item.admDate.slice(0, 7)" placeholder="입학연도" type="month" disabled />
      </div>
      <div class="garo_wrapper_lr" style="grid-area: eduLevel">
        <label class="resume_label" class="garo_wrapper_lr_l">학력구분:</label>
        <textarea class="resume_textarea" class="garo_wrapper_lr_r" :value="item.eduLevel" placeholder="학력구분" disabled />
      </div>
      <div class="garo_wrapper_lr" style="grid-area: grdStatus">
        <label class="resume_label" class="garo_wrapper_lr_l">졸업여부:</label>
        <textarea class="resume_textarea" class="garo_wrapper_lr_r" :value="item.grdStatus" placeholder="졸업여부" disabled />
      </div>
      <div class="garo_wrapper_lr" style="grid-area: grdDate">
        <label class="resume_label" class="garo_wrapper_lr_l">졸업연도:</label>
        <textarea class="resume_textarea" class="garo_wrapper_lr_r" :value="item.grdDate.slice(0, 7)" placeholder="졸업연도" type="month" disabled />
      </div>
      <div class="garo_wrapper_lr" style="grid-area: schoolName">
        <label class="resume_label" class="garo_wrapper_lr_l">학교명:</label>
        <textarea class="resume_textarea" class="garo_wrapper_lr_r" :value="item.schoolName" placeholder="학교명" disabled />
      </div>
      <div class="garo_wrapper_lr" style="grid-area: major">
        <label class="resume_label" class="garo_wrapper_lr_l">전공명:</label>
        <textarea class="resume_textarea" class="garo_wrapper_lr_r" :value="item.major" placeholder="전공명" disabled />
      </div>
  ...
  <div>
    <div class="edu_table" v-if="isAddEdu && props.isShow">
      <div class="garo_wrapper_lr" style="grid-area: admDate">
        <label class="resume_label" class="garo_wrapper_lr_l">입학연도:</label>
        <input class="resume_input" class="garo_wrapper_lr_r" v-model=edu.admDate id="admDate" placeholder="입학연도" type="month"></input>
      </div>
      <div class="garo_wrapper_lr" style="grid-area: eduLevel">
        <label class="resume_label" class="garo_wrapper_lr_l">학력구분:</label>
        <select class="resume_select" class="garo_wrapper_lr_r" v-model=edu.eduLevel id="eduLevel" placeholder="학력구분">
      ...
      <div class="garo_wrapper_lr" style="grid-area: grdStatus">
        <label class="resume_label" class="garo_wrapper_lr_l">졸업여부:</label>
        <select class="resume_select" class="garo_wrapper_lr_r" v-model=edu.grdStatus id="grdStatus" placeholder="졸업여부">
      ...
      <div class="garo_wrapper_lr" style="grid-area: grdDate">
        <label class="resume_label" class="garo_wrapper_lr_l">졸업연도:</label>
        <input class="resume_input" class="garo_wrapper_lr_r" v-model=edu.grdDate id="grdDate" placeholder="졸업연도" type="month"></input>
      </div>
      <div class="garo_wrapper_lr" style="grid-area: schoolName">
        <label class="resume_label" class="garo_wrapper_lr_l">학교명:</label>
        <input class="resume_input" class="garo_wrapper_lr_r" v-model=edu.schoolName id="schoolName" placeholder="학교명"></input>
      </div>
      <div class="garo_wrapper_lr" style="grid-area: major">
        <label class="resume_label" class="garo_wrapper_lr_l">전공명:</label>
        <input class="resume_input" class="garo_wrapper_lr_r" v-model=edu.major id="major" placeholder="전공명"></input>
      </div>
      <div class="garo_wrapper_r" style="grid-area: button; display: flex; justify-content: right; align-items: center;">
