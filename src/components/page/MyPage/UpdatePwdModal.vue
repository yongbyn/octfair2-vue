  ...
  <div class="findPwdModal">
    <div class="findPwdModalContent">
      ...
      <div class="d-flex align-items-center">
        ...
        <b-button class="handlerFindPwdBtn ms-2" @click="handlerUpdatePwdValid">
          수정
        </b-button>
      </div>
    </div>
...
const handlerUpdatePwdValid = async () => {
  ...
  if (updateStatus.value === 1) {
    ...
    toast.error("현재 비밀번호가 일치 하지 않습니다.");
  }
};

// 비밀번호 수정
const { mutateAsync: handlerUpdatePwd } = useUpdatePwd(updatePwd, updateStatus);
