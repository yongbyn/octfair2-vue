...
export const useResumeDetailReadQuery = (resIdx, resume, isEditor) => {
  return useQuery({
    queryKey: ["resumeDetail", resIdx],
    queryFn: () => resumeDetailReadApi(resIdx, resume, isEditor), // resIdx가 입력된 경우만 작동
